...
import my.home.geekmarket.repositories.ProductRepository;
...
public class ProductService {
    ...
    public List<Product> getAllProductsWithFilter(Specification<Product> productSpecification) {
    ...
    public Page<Product> getProductsWithPagingAndFiltering(
            int pageNumber,
            int pageSize,
